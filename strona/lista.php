            ...
            <div class="contaier">
                ...
                <div id="formularz">
                    <form action="lista.php" method="post">
                        <div class="mb-3">
                            <label for="kolumna" class="form-label">Szukaj według: </label>
                            <select name="kolumna" id="kolumna" class="form-select">
                            ...
                            <div class="mb-3">
                                <input type="text" id="login" name="szukaj" required>
                            </div>
                ...
                <div class="table-responsive text-center offset-md-3 col-md-6 offset-md-3">
                    ...
                    if ($wynik->num_rows > 0) {
                        ...
                        while ($row = $wynik->fetch_assoc()) {
                            ...
                            echo "<td><a href=\"reset.php?id=" . $row['id'] . "\"><i class='material-icons' style='color:#0d6efd;'>restart_alt</i></a></td>";
                            echo "<td><a href=\"usun.php?id=" . $row['id'] . "\"><i class='material-icons' style='color:#0d6efd;'>delete</i></a></td>";
